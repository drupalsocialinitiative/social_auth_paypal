...
class PaypalAuthSettingsForm extends SocialAuthSettingsForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['paypal_settings']['authorized_redirect_url'] = [
      '#type' => 'textfield',
      '#disabled' => TRUE,
      '#title' => $this->t('Authorized redirect URIs'),
      '#description' => $this->t('Copy this value to <em>Authorized redirect URIs</em> field of your Paypal App settings.'),
      '#default_value' => $GLOBALS['base_url'] . '/user/login/paypal/callback',
    ];

    $form['paypal_settings']['authorized_javascript_origin'] = [
      '#type' => 'textfield',
      '#disabled' => TRUE,
      '#title' => $this->t('Authorized Javascript Origin'),
      '#description' => $this->t('Copy this value to <em>Authorized Javascript Origins</em> field of your Paypal App settings.'),
      '#default_value' => $this->requestContext->getHost(),
    ];

    $form['paypal_settings']['scopes'] = [
      '#type' => 'textarea',
